      ...
      <div class="col-12 col-md-6">
        <div class="contacts contacts-info">
          <div class="contacts-info-contacts">
            ...
            <a href="tel:+380445007788" class="contacts-info--item"><i class="icon fas fa-phone-alt"></i>+380 (44) 500 77 88</a>
            <a href="tel:+380674063545" class="contacts-info--item"><i class="icon fas fa-phone-alt"></i>+380 (67) 406 35 45</a>
